...
export class Backend implements backendInterface {
    ...
    async addBrand(arg0: number, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBrand(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addProvider(arg0: number, arg1: string, arg2: string, arg3: string, arg4: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProvider(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProvidersSortedByPayment(): Promise<Array<VirtualAssistantProvider>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProvidersSortedByPayment();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
