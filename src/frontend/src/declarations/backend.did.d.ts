...
export interface _SERVICE {
  'addBrand' : ActorMethod<[number, string, string, string], undefined>,
  'addProvider' : ActorMethod<
    [number, string, string, string, number],
    undefined
  >,
  'getAllBrands' : ActorMethod<[], Array<Brand>>,
  'getProvidersSortedByPayment' : ActorMethod<
    [],
    Array<VirtualAssistantProvider>
  >,
}
